    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.departments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(related_name='students', to='school.courses')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.departments')),
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.levels')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='faculty',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.faculties'),
        ),
        migrations.CreateModel(
            name='Guardians',
            fields=[
        ...
        migrations.AddField(
            ...
            name='dean',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.lecturers'),
        ),
        migrations.AddField(
            model_name='departments',
            name='h_o_d',
            field=models.OneToOneField(blank=True, db_column='h_o_d', null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.lecturers'),
        ),
        migrations.AddField(
            model_name='courses',
            name='lecturer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.lecturers'),
        ),
        migrations.CreateModel(
            name='Results',
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.courses')),
